  ...
  experiences: [
    {
      ...
      location: 'Remote',
      time: '2022 - current',
      description: `As a Senior Software Developer for Wizeline I was involved in the planning, architecture, deployment and development of a new platform.
      **Highlights** include:\
    ...
    },
    {
      ...
      location: 'Remote',
      time: '2021 - 2022',
      description: 'As a Senior Software Developer for Skupos, I was involved in planning and estimation for new features, I worked closely with Product and Marketing to set campaign goals and statistics, set up a few goals in Google Analytics, approved and reviewed PRs and releases in AWS Pipelines. **Highlights** include: - Leading a new internal design system - Working with Product and Marketing to define goals and set external tools - Implementing a new CI/CD pipeline with GitHub Actions for the internal design system - Implementing Cypress from scratch from our web app with 80% coverage.',
      technologies: [
        'React',
        'Material UI',
        'TypeScript',
    ...
    },
    {
      ...
      time: '2018 - 2019',
      description: 'As a Senior Software Developer for Nextiva, I was involved in improving the security and performance of the app. **Highlights** include: - Lead initiative to improve deployment performance, decreasing 60% build time - Worked with Backend to set up session using JWToken  - Add test 70% of test coverage. - Setup nginx to avoid COORS issues in internal apps.',
      technologies: [
        'TypeScript',
        'React',
        'Redux',
    ...
    },
    {
      ...
      location: 'Guadalajara, México',
      time: '2016 - 2018',
      description: 'As a Senior Software Developer for HomrAway, I was involved in migrating the onboarding flow and the property management flow from Java/Spring/JSP to React/Typescript/Node. **Highlights** include: - Debugging crucial parts of the property state machine.',
      technologies: [
        'TypeScript',
        'React',
        'Redux',
  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Listening to your music collection from the cloud (Dropbox)',
      }
    ],
  },
  skills: [
